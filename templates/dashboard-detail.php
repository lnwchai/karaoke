<?php 
/**
 * Template Name: Dashboard Detail
 */
    ...
    <div class="page-content booking-main">
        ...
        <div class="booking-detail">
            ...
            <div class="info">
                ...
                <p>Room : <?php echo get_the_title($room); ?> (<?php echo get_field('num-start', $room); ?>-<?php echo get_field('num-max', $room)?>ท่าน)</p>
            ...
            <?php else: ?>
                <div class="pic-payment">
                    <?php
                    $pic = get_field('slip', $pid);
